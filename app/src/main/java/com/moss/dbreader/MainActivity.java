...
//    }
    ...
    public void onServiceConnected(ComponentName componentName, IBinder iBinder) {
        ...
        bOK = true;
        engine.addNotify(new IFetchNovelEngineNotify() {
            @Override
            ...
            @Override
            public void OnFetchNovel(boolean bRet, final int engineID, final int sessionID,final DBReaderNovel local) {
...
//                        for (int i = 0; i < local.chapters.size(); i++) {
//                            ReaderPageAdapter.ReaderPage page = new ReaderPageAdapter.ReaderPage();
//                            page.chapterIndex = i;
//                            page.begin = page.end = -1;
//                            page.name = local.chapters.get(i).name;
//                            adp.addPage(page);
//                            engine.fetchChapter(local.chapters.get(i), engineID, sessionID);
//                        }
//                        vp.setAdapter(adp);
//                    }
//                });
...
//                }
            ...
            @Override
            public void OnFetchChapter(boolean bRet, int sessionID, final int index, final String cont) {
                if (!bRet) {
                    return;
                }
//                MainActivity.this.runOnUiThread(new Runnable() {
...
//                    public void run() {
//                        ViewPager vp = (ViewPager) findViewById(R.id.reader_viewpager);
//                        ReaderPageAdapter adp = (ReaderPageAdapter) vp.getAdapter();
//                        adp.addText(index,cont);
//                    }
//                });
            }
        });
        engine.searchNovel("大明", 0);
    }
...
//            engine.addNotify(new IFetchNovelEngineNotify() {
//                @Override
//                public void OnSearchNovels(boolean bRet, final int engineID, final int sessionID, final ArrayList<DBReaderNovel> novels) {
//
//                }
//
//                public void OnFetchNovel(final  boolean bRet, final int engineID, final int sessionID, final DBReaderNovel local){
//                    if (!bRet) {
//                        return;
//                    }
//                    MainActivity.this.engineID = engineID;
//                    MainActivity.this.runOnUiThread(new Runnable() {
//
//                        @Override
//                        public void run() {
